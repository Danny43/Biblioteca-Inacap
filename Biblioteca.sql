...
CREATE TABLE `correo_electronico_cliente` (
  `idcorreo_electronico` int(11) NOT NULL,
...
CREATE TABLE `correo_electronico_trabajador` (
  `idcorreo_electronico_trabajador` int(11) NOT NULL,
  `direc_corr_elec` varchar(45) NOT NULL,
  `trabajador_idtrabajadores` int(11) NOT NULL,
...
CREATE TABLE `factura` (
  ...
  `metodo_pago_idmetodo_pago` int(11) NOT NULL,
  PRIMARY KEY (`folio`),
  KEY `fk_factura_distribuidor1_idx` (`distribuidor_iddistribuidor`),
  KEY `fk_factura_metodo_pago1_idx` (`metodo_pago_idmetodo_pago`),
  CONSTRAINT `fk_factura_distribuidor1` FOREIGN KEY (`distribuidor_iddistribuidor`) REFERENCES `distribuidor` (`iddistribuidor`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `libro` VALUES ('20203030',570,25000,1,NULL,NULL,1,1,1,1,NULL,1);
...
-- Dump completed on 2018-06-03 21:27:39
